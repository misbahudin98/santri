...
class User_model
{
    ...
    public function login()
    {
        if (isset($_POST['username'], $_POST['password'])) {
            ...
            where  a.username =:username  and a.status_akun = '1' ";
            $this->db->query($query);
    ...
    public function tambah()
    {
        ...
        if (isset($_POST['username']) && $us == 0) {
            ...
            INSert into $this->table2 (id_user,nama) values(@a,:username); ";
            $this->db->query($query);
            $this->db->bind('username', $username);
